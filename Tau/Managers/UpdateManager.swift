...
class UpdateManager {
    public static let shared: UpdateManager = .init(URL(string: "https://cylorine.studio/meta/tau/update.json")!)
    ...
    public func installUpdate(_ version: UpdateModel.Version, useMirror: Bool = true) async throws {
        ...
        let appBundleName: String = Bundle.main.bundleURL.lastPathComponent
        let newBundle: URL = URLConstants.tempURL.appending(path: appBundleName)
        ...
        _ = try FileManager.default.replaceItemAt(
            ...
            backupItemName: "\(appBundleName).backup",
