...
public enum Requests {
    public static var allowExternalNetworkConnections: Bool = true
    ...
    public static func request(
        ...
        if !allowExternalNetworkConnections, isExternalURL(url) {
            throw RequestError.externalConnectionsDisabled(url: url.absoluteString)
        }
